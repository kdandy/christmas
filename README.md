...
```bash
git clone https://github.com/kdandy/christmas
```
...
- Open the [demo page](https://christmas-dandy.netlify.app/)
- Open the [source code](http://github.com/kdandy/christmas)
...
Have a bug or an issue with this template? [Open a new issue](https://github.com/kdandy/christmas/issues/new) here on GitHub.
